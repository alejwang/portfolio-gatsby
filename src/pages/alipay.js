  ...
  <WorkPage id={workId} fromList={(location.state && location.state.fromList) != undefined ? location.state.fromList : "selected"}> 
    <InfoPanelGroup>
        ...
        <InfoGroup>
          ...
          <InfoText><a href="https://www.antfin.com/index.htm?locale=en_US" target="_blank">Ant Financial<span className="linkarrow">></span></a><br/> <a href="https://global.alipay.com/index.htm" target="_blank">Alipay App<span className="linkarrow">></span></a> <br/> K.P. Wang - Mentor <br /> Huajing Jin - Supervisor</InfoText>
        </InfoGroup>
        <MainText>
    ...
    <SectionForImages>
      ...
      <ImageText>
        Powered by <a href="https://whimsical.com" target="_blank">Whimsical<span className="linkarrow">></span></a> .
      </ImageText>
    </SectionForImages>

    <Section>
      <ChapterTitle>Other Projects</ChapterTitle>
      <SectionTitle>Using my work time and free time, I also worked on brainstorming new ideas and some motion designs. Powered by <a href="https://framer.com" target="_blank">Framer Studio<span className="linkarrow">></span></a> and <a href="https://airbnb.design/lottie/" target="_blank">Lottie<span className="linkarrow">></span></a>.</SectionTitle>
    </Section>
